"""
Fake logger lets you populate a dummy log file. It will be filling it with random gibberish for the
time you specify. Once that time has passed, a target log message will be added to dummy log file.
Target message means a line that you're looking for. This can be used for unit testing or (mainly)
...
def main():
    ...
    parser.add_argument('-l', '--log-file', action='store', required=True,
    ...
    parser.add_argument('-m', '--max-interval', action='store', default=1, type=int,
    ...
    parser.add_argument('-t', '--target-msg', action='store', default=TARGET_MSG,
