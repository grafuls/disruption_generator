...
SUBTEMPLATES_ORDER = [
    'clusters', 'hosts', 'storages', 'extra_storages', 'external_providers',
    'external_templates', 'vms_header', 'vms', 'users', 'groups'
]
...
SUBTEMPLATES = {
    ...
    'storages': {
        ...
        'additional': {
            'domain_function': {
                'template': 'domain_function'
            },
            'nfs': {
                'template': 'storage_nfs'
            },
            'iscsi': {
    ...
    'external_providers': {
        ...
        'additional': {
            'authentication': {
                'template': 'external_provider_auth'
            }
        }
    },
    'external_templates': {
